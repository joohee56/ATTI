...
CREATE TABLE `user_comment_like` (
  `user_comment_like_id` bigint NOT NULL AUTO_INCREMENT,
  `comment_id` bigint DEFAULT NULL,
  `user_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`user_comment_like_id`),
  KEY `FKd74al4ur6la2cwsfe1wnoc6ln` (`comment_id`),
  KEY `FKcrvxfmk8amhbcgleob8niyrcj` (`user_id`),
  CONSTRAINT `FKcrvxfmk8amhbcgleob8niyrcj` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `FKd74al4ur6la2cwsfe1wnoc6ln` FOREIGN KEY (`comment_id`) REFERENCES `comment` (`comment_id`)
...
INSERT INTO `user_comment_like` VALUES (1,15,'jeongjin'),(6,10,'dustnzlzl');
