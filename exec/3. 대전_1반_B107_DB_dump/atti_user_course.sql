...
CREATE TABLE `user_course` (
  ...
  CONSTRAINT `FKka18m18kpimodvy8yg2icu083` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`),
  CONSTRAINT `FKpv8tt3252hb6kyej8p7e7pokl` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
