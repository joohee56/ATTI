...
CREATE TABLE `file` (
  ...
  `file_new` varchar(255) DEFAULT NULL,
  ...
  KEY `FK4n92ei4wwxqu3327y048usdrv` (`depart_id`),
  KEY `FKinph5hu8ryc97hbs75ym9sm7t` (`user_id`),
  CONSTRAINT `FK4n92ei4wwxqu3327y048usdrv` FOREIGN KEY (`depart_id`) REFERENCES `depart` (`depart_id`),
  CONSTRAINT `FKinph5hu8ryc97hbs75ym9sm7t` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `FKliehgj4h8qwdp6iy221v5p6ss` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`)
