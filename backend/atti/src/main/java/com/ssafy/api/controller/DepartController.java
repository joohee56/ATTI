...
//		System.out.println("===========================" + departId + "=============================");
	...
	/*
	 * @GetMapping("/{departId}/category/{categoryId}/post") // 게시글 전체 조회 public
	 * ResponseEntity<List<PostViewAllRes>> viewAllPosts(@PathVariable Long
	 * departId, @PathVariable Long categoryId) {
	 * System.out.println("===========================" + departId +
	 * "=============================");
	 * System.out.println("===========================" + categoryId +
	 * "============================="); return new
	 * ResponseEntity<List<PostViewAllRes>>(postService.viewAllPosts(departId,
